...
@section('title')
    لوحة التحكم - الشبلي للادارة القانونية
@stop
@section('css')
    <!--  Owl-carousel css-->
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-14 text-white op-7"> عدد الفواتير {{ \App\Models\Invoice::count() }}</p>
                            </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-14 text-white op-7">عدد الفواتير الغير مدفوعة {{ \App\Models\Invoice::where('Value_Status',2)->count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
