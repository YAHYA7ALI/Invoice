...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الأعدادات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/قائمة الأقسام</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-sm-5 col-md-3 col-xl-2">
                            <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-newspaper" data-toggle="modal" href="#modaldemo8"><i class="fas fa-plus"></i> اضافة قسم
                            </a>
                        </div>
                        @endcan
                    </div>
                ...
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="{{ route('sections.store') }}" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn ripple btn-secondary" data-dismiss="modal" type="reset"> اغلاق </button>
                        </div>
                    </form>
                </div>
            </div>
