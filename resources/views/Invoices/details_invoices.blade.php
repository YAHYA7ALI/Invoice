                                                    ...
                                                    @foreach ($details as $x)
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if ($x->Value_Status == 1)
                                                                <td>
                                                                    <span
                                                                        class="badge badge-pill badge-success">{{ $x->status }}
                                                                    </span>
                                                                </td>
                                                            @elseif($x->Value_Status ==3)
                                                                <td>
                                                                    <span
                                                                        class="badge badge-pill badge-warning">{{ $x->status }}
                                                                    </span>
                                                                </td>
                                                            @else
                                                                <td>
                                                                    <span
                                                                        class="badge badge-pill badge-danger">{{ $x->status }}
                                                                    </span>
                                                                </td>
                                                            @endif
                                                ...
                                                @can('اضافة مرفق')
                                                    <div class="card-body">
                                                        ...
                                                        <form method="post" action="{{ url('/InvoiceAttachments') }}" enctype="multipart/form-data">
                                                            ...
                                                            <br>
                                                            <br>
                                                            <button type="submit" class="btn btn-primary btn-sm" name="uploadedFile" style="font-size: 15px;">تاكيد</button>
                                                        </form>
                                                    </div>
                                                @endcan    
                                                <br>
